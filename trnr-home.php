...
<head>
    ...
    <title>TRAINER</title>
</head><script src="https://kit.fontawesome.com/4c890c6a79.js" crossorigin="anonymous"></script>
<style>
...
<body>
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                <li id="active"><a href="trnr-home.php" id="active"><i class="fas fa-home"></i>HOME</a></li>
