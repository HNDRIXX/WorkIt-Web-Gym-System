    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li id="active"><a href="mem-sessions.php" id="active"><i class="fas fa-calendar"></i>SESSIONS</a></li>
        ...
        <?php $welcomeName = $_SESSION['full_name']; ?>
            ...
            <div class="announcement">
                <p id="title" style="margin-bottom: 20px;">SESSIONS</p><hr>
                        ...
                        $query = "SELECT * FROM session_vw WHERE memID = '$memID'";
