...
if (isset($_POST['submit-button'])){
    ...
    $insert = "INSERT INTO gymacc (unique_id,username) 
	VALUES ('$unique_id','$username')";
    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li id="active"><a href="admin-users.php"  id="active"><i class="fas fa-users"></i>USERS</a></li>
        ...
        <div class="main_content">
            ...
            <div class="announcement">
                <p id="title" style="margin-bottom: 20px;">USERS</p><hr>
                ...
                <div id="popupmember" class="overlay">
                    ...
                    <form action="admin-users.php" method="POST">
                        <div class="content">
                            <label>ID</label><input type="text" placeholder="ID" name="unique_id"><br>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                echo "<tr>";
                                        ...
                                        echo "<td><a href='edit-admin-users.php?unique_id=".$row['unique_id'].
                                            "&username=".$row['username']."&password=".$row['password']."&roles=".$row['roles']."'> 
