    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li id="active"><a href="mem-settings.php" id="active"><i class="fas fa-cog"></i>SETTINGS</a></li>
        ...
        <div class="main_content">
            ...
            <div class="header"><?php echo $msg,$welcomeName; ?>.<img src="image/header.png" alt=""></div>  
                ...
                <div class="announcement">
                    <p id="title" style="margin-bottom: 20px;">SETTINGS</p><hr>
                    ...
                    <div class="account-content">
                        <div>
                            ...
                            <p>Password</p>
                            <a href="mem-settings.php?changepass=1" class="changebutton" name="changepass">Change</a>
                            <?php  
                                if (isset($_GET['changepass'])){
                                    ...
                                    {
                                        echo "<script> location.replace('mem-settings.php'); </script>";
                                    }
                                    echo "<br>";
