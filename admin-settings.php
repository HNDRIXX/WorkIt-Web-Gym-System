    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li id="active"><a href="admin-settings.php" id="active"><i class="fas fa-cog"></i>SETTINGS</a></li>
        ...
        <div class="main_content">
            ...
            <div class="announcement">
                <p id="title" style="margin-bottom: 5px;">SETTINGS</p><hr>
                    ...
                    <div class="account-content">
                        <div>
                            ...
                            <p>Password</p>
                            <a href="admin-settings.php?changepass=1" class="changebutton" name="changepass">Change</a>
                            <?php  
