    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li id="active"><a href="trnr-sessions.php" id="active"><i class="fas fa-calendar"></i>SESSIONS</a></li>
                <li><a href="trnr-profile.php"><i class="fas fa-user"></i>PROFILE</a></li>
                <li><a href="trnr-settings.php"><i class="fas fa-cog"></i>SETTINGS</a></li>
        ...
        <div class="main_content">
            ...
            <div class="announcement">
                <p id="title" style="margin-bottom: 20px;">SESSIONS</p><hr>
                        ...
                        $query = "SELECT * FROM session_vw WHERE trnID = '$trainerID'";
